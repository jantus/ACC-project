...
def work(self, run_args, airfoil_args, xml_filename):
	...
	for data_file in os.listdir(path):
		...
		print file_path +" = "+xml_filename
		
		if extension == ".xml" and file_path  == xml_filename:
			print "TASK:", data_file, xml_filename
			
		
			## start new worker
			airfoil(airfoil_args["num_samples"], airfoil_args["visc"], airfoil_args["speed"], airfoil_args["T"], "../msh/"+data_file)
